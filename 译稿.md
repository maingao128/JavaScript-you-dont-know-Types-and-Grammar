...
<table>
    <tr style="border: none;">
        <td style="border: none; width: 150px;"><img src='images/warning.png'></td>
        <td style="border: none;">这些“抽象相等”规则导致<i>隐式</i>强制类型转换被诟病为过于复杂以及容易出错。程序员觉得它们太晦涩，很难掌握和使用，其带来的坏处（导致bug）多过好处（提高代码可读性）。这样的观点我不敢苟同，因为本书的读者都是优秀的程序员，整天与算法和代码打交道，掌握“抽象相等”简直是小菜一碟。不过我还是推荐大家看一下ES5规范的11.9.3节，你会发现其中说的很有道理。</td>
    </tr>
</table>
...
<table>
    <tr style="border: none;">
        <td style="border: none; width: 150px;"><img src='images/note.png'></td>
        <td style="border: none;">严格相等<b>===</b>的定义和11.9.3.1一样，包括两个对象的相等比较。有一点不太为人所知，既在比较两个对象的时候，<b>==</b>和<b>===</b>的工作原理是一样的。</td>
    </tr>
</table>
...
<table>
    <tr style="border: none;">
        <td style="border: none; width: 150px;"><img src='images/note.png'></td>
        <td style="border: none;"><b>!=</b>宽松不相等（loose not-equality）的定义和我们设想的一样，既<b>==</b>的相反值。<b>!==</b>也是同理。</td>
    </tr>
</table>
