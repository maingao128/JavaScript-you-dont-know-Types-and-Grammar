...
<table>
    <tr style="border: none;">
        <td style="border: none; width: 150px;"><img src='images/note.png'></td>
        <td style="border: none;">这和<b>!</b>很相像，它不仅将值强制类型转换为<b>boolean</b>，还对其做字位反转（见第83页“显式强制类型转换：*-->Boolean”）。</td>
    </tr>
</table>
...
<table>
    <tr style="border: none;">
        <td style="border: none; width: 150px;"><img src='images/note.png'></td>
        <td style="border: none;"><b>-(x+1)</b>似乎意味着<b>~-1</b>的结果是<b>-0</b>，但是实际上结果是<b>0</b>，因为它是字位操作而非数学运算。</td>
    </tr>
</table>
