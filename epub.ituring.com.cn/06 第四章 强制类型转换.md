...
<table>
    <tr style="border: none;">
        ...
        <td style="border: none;"><i>《JavaScript: The Good Parts》</i>的作者Douglas Crockford在许多场合和文章中都主张不要使用强制类型转换。他认为<i>隐式</i>强制类型转换非常糟糕。然而他的代码中也大量使用了<i>隐式</i>和<i>显式</i>强制类型转换。实际上他的吐槽大部分是针对<b>==</b>运算符，但读完本章你会发现这只是强制类型转换的冰山一角。</td>
    </tr>
</table>
